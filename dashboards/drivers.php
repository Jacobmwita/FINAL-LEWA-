...
if (!isset($_SESSION['user_id']) || !in_array(strtolower($_SESSION['user_type'] ?? ''), ['admin', 'administrator', 'workshop_manager', 'service_advisor'])) {
...
// Fetch only drivers
$drivers = [];
$sql = "SELECT user_id, username, email, full_name, phone_number, user_type FROM users WHERE user_type = 'driver' ORDER BY user_id DESC";
        ...
        <div class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo BASE_URL; ?>/dashboards/drivers.php" class="active"><i class="fas fa-users"></i> View Drivers</a></li>
